...
<tr>
	...
	<th style="width:200px">enabled</th>
		...
		<tr>
			<td><a href="/ex/admin/user/delete?username=${dto.username}">삭제</a></td>
			<td>${dto.username}</td>
			<td>${dto.password}</td>
			<td>${dto.enabled }</td>
		</tr>
...
<a href='/ex/admin/user/update?username=${dto.username }&password=${dto.password}&enabled=${dto.enabled}'>수정</a>
