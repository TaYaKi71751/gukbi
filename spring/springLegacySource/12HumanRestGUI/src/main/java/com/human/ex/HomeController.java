...
public class HomeController {
	...
	public String updateDB(HumanDto employeesDto,RedirectAttributes rttr) throws Exception{
		service.update(employeesDto);
	...
	public String insertDB(HumanDto employeesDto,RedirectAttributes rttr) throws Exception{
		service.insert(employeesDto);
		rttr.addFlashAttribute("msg","success");
		return "redirect:/selectAll";
	}
