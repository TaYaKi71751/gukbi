...
import com.human.service.UploadService;
...
public class UploadController {
	...
	public ResponseEntity<String> uploadAjax(MultipartFile file,Integer bno) throws Exception {
		...
		um.addFile(uploadedFileName, bno);
	...
	public ResponseEntity<List<String>> allFile(Integer bno) throws Exception {
...
//		list.add("aa");
	    ...
	    try {
	    	entity = new ResponseEntity<>(um.getFiles(bno), HttpStatus.OK);
	    } catch (Exception e) {
	      e.printStackTrace();
	      entity = new ResponseEntity<>(HttpStatus.BAD_REQUEST);
	    }
